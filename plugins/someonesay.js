...
if (Config.WORKTYPE == 'private') {
    ...
    Bixby.addCommand({ pattern: 'someonesay ?(.*)', fromMe: true, desc: Lang.ANIME_DESC }, (async (message, match) => {
        ...
        await message.client.sendMessage(message.jid,Buffer.from(ttinullimage.data), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by Bixby' })

    }));

    Bixby.addCommand({ pattern: 'changesay ?(.*)', fromMe: true, desc: Lang.CHANGE_DESC }, (async (message, match) => {
    ...
    Bixby.addCommand({ pattern: 'trumpsay ?(.*)', fromMe: true, desc: Lang.TRUMP_DESC }, (async (message, match) => {
    ...
    Bixby.addCommand({ pattern: 'changesay ?(.*)', fromMe: false, desc: Lang.CHANGE_DESC }, (async (message, match) => {
    ...
    Bixby.addCommand({ pattern: 'trumpsay ?(.*)', fromMe: false, desc: Lang.TRUMP_DESC }, (async (message, match) => {
